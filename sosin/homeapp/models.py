...
class Stock(models.Model):
    code = models.ForeignKey(StockInfo, on_delete=models.CASCADE, related_name='stock', null=True)
...
class Coin(models.Model):
    date = models.DateTimeField('DATE', default=timezone.now) # 날짜
    code = models.ForeignKey(CoinInfo, on_delete=models.CASCADE, related_name='stock', null=True)
    sise = models.PositiveIntegerField('SISE', blank=False)
